...
- [x] TASK-IDENT-004 Inventory package metadata, CLI help/output, scripts, generated services/configuration, installation commands, and installed payload identifiers; verify they remain SpecForge-based, add a regression check against accidental Agentsembli renaming, and confirm clean install, update, rollback, and uninstall require no identity migration.
