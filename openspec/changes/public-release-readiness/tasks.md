...
- [x] TASK-PUB-010 Add a CLI version command or flag plus tested update-to-tag, rollback-to-tag, and uninstall/removal behavior that preserves target-owned OpenSpec, Beads, config, and unrelated agent settings; verify all lifecycle scenarios in throwaway repositories.
